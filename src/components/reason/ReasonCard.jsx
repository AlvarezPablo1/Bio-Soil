...
const ReasonCard = () => {
  return (
    <>
    <div className='flex flex-col md:flex-row bg-[#FFFF]'>
      <section className=''>
        <Image src={reasonOne} alt='example image'/>
      </section>
      <div className='relative md:w-[700px] lg:w-[500px]'>
        <section className='absolute text-[#DADADA] text-[100px] lg:text-[140px] min-[1440px]:text-[180px] font-[700] right-0 md:right-[.2rem] min-[1440px]:right-[-9rem] top-[-1rem] md:top-[-2rem] lg:top-[-3rem] font-[DMsans]'>1</section>
    ...
    <div className='flex flex-col-reverse justify-between md:flex-row bg-[#202020] text-[#FFFF]'>
      <div className='relative md:w-[738px] lg:w-[710px]'>
        <section className='absolute text-[#5A5A5A] text-[100px] lg:text-[140px] min-[1440px]:text-[180px] font-[700] right-0 md:right-[.2rem] min-[1440px]:right-[-2rem] top-[-1rem] md:top-[-2rem] lg:top-[-3rem] font-[DMsans]'>2</section>
    ...
    <div className='flex flex-col md:flex-row bg-[#FFFF]'>
      ...
      <div className='relative md:w-[700px] lg:w-[500px]'>
        <section className='absolute text-[#DADADA] text-[100px] lg:text-[140px] min-[1440px]:text-[180px] font-[700] right-0 md:right-[.2rem] min-[1440px]:right-[-9rem] top-[-1rem] md:top-[-2rem] lg:top-[-3rem] font-[DMsans]'>3</section>
        <section className='flex flex-col gap-y-4 w-[320px] lg:w-[500px] min-[1440px]:w-[540px] text-[15px] md:text-[12px] lg:text-[16px] min-[1440px]:text-[20px] font-[400] pt-10 md:pt-8 lg:pt-14 min-[1440px]:pt-16 pl-4 md:pl-8 min-[1440px]:pl-16'>
    ...
    <div className='flex flex-col-reverse justify-between md:flex-row bg-[#202020] text-[#FFFF]'>
      <div className='relative md:w-[738px] lg:w-[710px]'>
        <section className='absolute text-[#5A5A5A] text-[100px] lg:text-[140px] min-[1440px]:text-[180px] font-[700] right-0 md:right-[.2rem] min-[1440px]:right-[-2rem] top-[-1rem] md:top-[-2rem] lg:top-[-3rem] font-[DMsans]'>4</section>
